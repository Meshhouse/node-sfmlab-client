   ...
   */
    ...
    async getModelComments(id) {
        ...
        try {
            ...
            const commentsRoot = cheerio_1.default.load(response.body);
    ...
    async parseModelPage(model) {
        ...
        try {
            ...
            const updatedModel = {
                ...
                description: sanitize_html_1.default(description, {
    ...
    getComments(parser) {
        ...
        for (let i = 0; i < comments.length; i++) {
            ...
            const commentBody = cheerio_1.default.load(comment);
